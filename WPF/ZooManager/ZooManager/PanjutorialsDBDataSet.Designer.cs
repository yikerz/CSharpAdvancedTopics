...
namespace ZooManager {
    ...
    public partial class PanjutorialsDBDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationZoo_FK;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationZoo_FK = this.Relations["Zoo_FK"];
        }
        ...
        private void InitClass() {
            ...
            this.relationZoo_FK = new global::System.Data.DataRelation("Zoo_FK", new global::System.Data.DataColumn[] {
                        this.tableZoo.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableZooAnimal.ZooIdColumn}, false);
            this.Relations.Add(this.relationZoo_FK);
        }
        ...
        public partial class ZooAnimalDataTable : global::System.Data.TypedTableBase<ZooAnimalRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ZooAnimalRow AddZooAnimalRow(ZooRow parentZooRowByZoo_FK, AnimalRow parentAnimalRowByAnimal_FK) {
                ZooAnimalRow rowZooAnimalRow = ((ZooAnimalRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        null,
                        null};
                if ((parentZooRowByZoo_FK != null)) {
                    columnValuesArray[1] = parentZooRowByZoo_FK[0];
                }
                if ((parentAnimalRowByAnimal_FK != null)) {
                    columnValuesArray[2] = parentAnimalRowByAnimal_FK[0];
                }
        ...
        public partial class ZooRow : global::System.Data.DataRow {
            ...
            public ZooAnimalRow[] GetZooAnimalRows() {
                if ((this.Table.ChildRelations["Zoo_FK"] == null)) {
                    return new ZooAnimalRow[0];
                }
                else {
                    return ((ZooAnimalRow[])(base.GetChildRows(this.Table.ChildRelations["Zoo_FK"])));
                }
            }
        }
        ...
        public partial class AnimalRow : global::System.Data.DataRow {
            ...
            public ZooAnimalRow[] GetZooAnimalRows() {
                if ((this.Table.ChildRelations["Animal_FK"] == null)) {
                    ...
                    return ((ZooAnimalRow[])(base.GetChildRows(this.Table.ChildRelations["Animal_FK"])));
                }
            }
        }
        ...
        public partial class ZooAnimalRow : global::System.Data.DataRow {
            ...
            public ZooRow ZooRow {
                get {
                    return ((ZooRow)(this.GetParentRow(this.Table.ParentRelations["Zoo_FK"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Zoo_FK"]);
                }
            }
        }
...
namespace ZooManager.PanjutorialsDBDataSetTableAdapters {
    ...
    public partial class ZooTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ZooManager.Properties.Settings.Default.PanjutorialsDBConnectionString;
        }
